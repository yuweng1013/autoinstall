...
sed -i "s/QQQipQQQ/$pmtaip/g" `grep "QQQipQQQ" -rl /etc/pmta/config`
sed -i "s/QQQhostnameQQQ/$pmtaip/g" `grep "QQQhostnameQQQ" -rl /etc/pmta/config`
sed -i "s/QQQportQQQ/$pmtaip/g" `grep "QQQportQQQ" -rl /etc/pmta/config`
